// src/pages/SchoolDetail/SchoolDetailPage.jsx - VERSI FINAL DENGAN ALUR DATA YANG BENAR
...
import Map from '../Map/Map'; // Import komponen Map yang sudah diperbaiki
...
// Error Boundary dan komponen Chart tetap sama (tidak perlu diubah)
...
const SchoolDetailPage = () => {
    ...
    const isValidCoordinate = useCallback((lat, lng) => (
        ...
        (lat !== 0 || lng !== 0) // Memperbolehkan salah satu 0, tapi tidak keduanya
    ), []);
    ...
    // PERBAIKAN: Menggunakan `transformDataForMap` untuk mengubah data
    const schoolsForMap = useMemo(() => {
        return filteredData.map(school => ({
            ...
            desa: school.desa,
            lintang: school.coordinates[0],
            bujur: school.coordinates[1],
            ...
            <main>
                <section className={`${styles.card} ${styles.mapCard} ${styles.fadeInUp}`}>
                    <div className={styles.cardHeader}>
                        <div className={styles.cardTitleGroup}><h2 className={styles.cardTitle}><span className={styles.cardIcon}>🗺️</span>Peta Sebaran Sekolah</h2><p className={styles.cardSubtitle}>Menampilkan {schoolsForMap.length} lokasi sekolah valid</p></div>
                        <div className={styles.mapLegend}><div className={styles.legendItem}><span className={styles.legendDot} style={{backgroundColor: '#10b981'}}></span><span>Baik</span></div><div className={styles.legendItem}><span className={styles.legendDot} style={{backgroundColor: '#f59e0b'}}></span><span>Perbaikan</span></div><div className={styles.legendItem}><span className={styles.legendDot} style={{backgroundColor: '#ef4444'}}></span><span>Buruk</span></div></div>
                    </div>
                    {/* PERBAIKAN: Mengirim data yang benar ke komponen Map */}
                    <div className={styles.mapContainer}><div className={styles.mapWrapper}><ErrorBoundary><Map schoolData={schoolsForMap} geoData={geoData} mapView={mapView} /></ErrorBoundary></div></div>
                </section>
                ...
                <section className={`${styles.card} ${styles.fadeInUp}`}>
                    <div className={styles.cardHeader}>
                        ...
                        <div className={styles.tableActions}><button className={styles.exportButton}><span className={styles.exportIcon}>📥</span>Export Data</button></div>
                    </div>
