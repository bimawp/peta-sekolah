...
const SchoolDetailPage = () => {
    ...
    const schoolsForMap = useMemo(() => transformDataForMap(schoolData), [schoolData, transformDataForMap]);
        ...
        <div className={styles.pageContainer}>
            ...
            <main>
                <section className={`${styles.card} ${styles.mapCard} ${styles.fadeInUp}`}>
                    ...
                    <div className={styles.mapContainer}><div className={styles.mapWrapper}><ErrorBoundary><Map schools={schoolsForMap} /></ErrorBoundary></div></div>
                </section>
