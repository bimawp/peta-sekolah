  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.card}>
          <div className={styles.chartContainer}>
            <div className={styles.chart}>
              <div className={styles.barContainer}><div className={`${styles.bar} ${styles.barRed}`} style={{ height: calculateHeight(rusakBerat) }}>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.card}>
          <div className={styles.subsection}>
            ...
            <div className={styles.dataRow}><span>Lahan Tersedia: {getData(schoolData, ['building_status', 'tanah', 'land_available'], '0')} m²</span></div>
          </div>
          <div className={styles.subsection}>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.card}>
          <div className={styles.dataRow}><span>RGKS: {getData(schoolData, ['rgks', 'n_available'], 'Tidak Tersedia')}</span></div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.dataRow}><span>Kondisi Toilet Baik: {getData(schoolData, ['toilets', 'good'], '-')}</span></div>
          <div className={styles.dataRow}><span>Kondisi Toilet Rusak Sedang: {getData(schoolData, ['toilets', 'moderate_damage'], '-')}</span></div>
          <div className={styles.dataRow}><span>Kondisi Toilet Rusak Berat: {getData(schoolData, ['toilets', 'heavy_damage'], '-')}</span></div>
        </div>
      </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.card}>
          <div className={styles.dataRow}><span>Fasilitas UKS: {getData(schoolData, ['uks', 'n_available'], 'Tidak Tersedia')}</span></div>
        </div>
      </div>
    </div>
  );
